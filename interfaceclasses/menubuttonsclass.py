...
class MenuButtons:  # (ConkyLuaMaker_HelpClass) :
    def __init__(self, manager):
        ...
        menu = pygame_gui.elements.UIButton(
            relative_rect=MB_MENU_RECT, text="", manager=self.manager  # text="Menu",
        )
        ...
        save = pygame_gui.elements.UIButton(
            relative_rect=MB_SAVE_RECT, text="", manager=self.manager  # text="Save as",
        )
        ...
        self.help_text = {"test": "yghvighighlgihlgfvgbggggg", "actually_link": "youpi"}
    ...
    def display_help(self):
        ...
        self.help_box = pygame_gui.windows.UIMessageWindow(
            pygame.Rect((500, 100), (400, 350)),
